...
- **Rich Text**: [Tiptap](https://tiptap.dev/) or [Quill](https://quilljs.com/)
- **Syntax Highlighting**: [Highlight.js](https://highlightjs.org/) or [Prism.js](https://prismjs.com/)
- **Calendar**: [FullCalendar](https://fullcalendar.io/) (already using custom Alpine implementation)
- **Maps**: [Leaflet](https://leafletjs.com/) (lightweight alternative to Google Maps)
- **Drag & Drop**: [SortableJS](https://sortablejs.github.io/Sortable/) (already integrated)

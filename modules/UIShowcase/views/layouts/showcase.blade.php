                ...
                <nav class="space-y-1">
                    ...
                    <div>
                        ...
                        <div x-show="openSections.buttons" x-cloak class="ml-8 mt-1 space-y-1">
                            ...
                            <a href="{{ route('showcase.buttons') }}#button-with-dropdown" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Button with Dropdown</a>
                            <a href="{{ route('showcase.buttons') }}#floating-action-button-fab" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Floating Action Button</a>
                            <a href="{{ route('showcase.buttons') }}#link-button" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Link Button</a>
                    ...
                    <div>
                        ...
                        <div x-show="openSections.feedback" x-cloak class="ml-8 mt-1 space-y-1">
                            ...
                            <a href="{{ route('showcase.feedback-drawers') }}#drawer-right" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Drawer - Right</a>
                            <a href="{{ route('showcase.feedback-drawers') }}#drawer-left" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Drawer - Left</a>
                            <a href="{{ route('showcase.feedback-drawers') }}#drawer-bottom" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Drawer - Bottom</a>
                    ...
                    <!-- Landing Pages -->
                    <div>
                        <button @click="toggleSection('landing')" class="w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-lg {{ request()->routeIs(['showcase.landing-hero', 'showcase.landing-pricing', 'showcase.landing-content']) ? 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <div class="flex items-center">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <svg class="w-4 h-4 transition-transform" :class="openSections['landing'] ? 'rotate-90' : ''" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path>
                            </svg>
                        </button>
                        <div x-show="openSections['landing']" x-cloak class="ml-8 mt-1 space-y-1">
                            ...
                            <a href="{{ route('showcase.landing-content') }}#footer-multi-column" class="block px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">Footer - Multi Column</a>
                        </div>
                    </div>
